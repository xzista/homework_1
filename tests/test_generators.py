...
def test_filter_by_currency(result_data_gen, expected_data_for_gen1):
    generator1 = filter_by_currency(transaction=result_data_gen, currency="RUS")
...
@pytest.mark.parametrize('value_min, value_max, result', [(9999_9999_9999_9999, 9999_9999_9999_9999, '9999 9999 9999 9999'),
