...
@pytest.mark.parametrize(
    "value, result", [(7000792289606361, "7000 79** **** 6361"), ("7000792289602222", "7000 79** **** 2222")]
)
...
@pytest.mark.parametrize("value, result", [(73654108430135874305, "**4305"), ("84301358758743051111", "**1111")])
